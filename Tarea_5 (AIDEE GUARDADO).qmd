...
plt.plot(x_values,  f(x_values), color = "deeppink", linewidth=1.5)
plt.grid()
plt.show()
```
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_005(x_values)), mode='lines', name='h=0.05', line=dict(color='pink', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-derivative(f, x_values).df), mode='lines', name='SciPy', line=dict(color='red', width=2)))
...
fig.add_trace(go.Scatter(x= x_values, y= ddf_005(x_values), mode='lines', name='h=0.05', line=dict(color='deeppink', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_005(x_values)), mode='lines', name='h=0.05', line=dict(color='deeppink', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= derf(x_values), mode='lines', name='Derivada', line=dict(color='deeppink', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= df_005(x_values), mode='lines', name='h=0.05', line=dict(color='deeppink', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_005(x_values)), mode='lines', name='h=0.05', line=dict(color='red', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-derivative(f, x_values).df), mode='lines', name='SciPy', line=dict(color='blue', width=2)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_01(x_values)), mode='lines', name='h=0.1', line=dict(color='purple', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_005(x_values)), mode='lines', name='h=0.05', line=dict(color='deeppink', width=1)))
...
plt.figure(figsize=(8,6))
plt.plot(x_values,  f(x_values), color = "darkgreen", linewidth=1.5)
plt.grid()
plt.show()
```
...
fig.add_trace(go.Scatter(x= x_values, y= df_125(x_values), mode='lines', name='h=0.125', line=dict(color='green', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_125(x_values)), mode='lines', name='h=0.125', line=dict(color='red', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_05(x_values)), mode='lines', name='h=0.05', line=dict(color='green', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= ddf_005(x_values), mode='lines', name='h=0.05', line=dict(color='purple', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= dderf(x_values), mode='lines', name='2da. derivada', line=dict(color='deeppink', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_125(x_values)), mode='lines', name='h=0.125', line=dict(color='orange', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_005(x_values)), mode='lines', name='h=0.05', line=dict(color='yellow', width=1)))
...
plt.figure(figsize=(8,6))
plt.plot(x_values,f(x_values), label="Función", color="red")
...
plt.plot(x[puntos_out_positivo], y[puntos_out_positivo], 'o', color="deeppink", label= "Puntos out +", alpha=0.5, markersize=2.5)
...
plt.figure(figsize=(8,6))
plt.plot(x_values,f(x_values), label="Función", color="darkgreen")
plt.fill_between(np.linspace(a,b, 100), y1=0, y2=f(np.linspace(a,b, 100)), color="lime", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
```
...
plt.plot(x[puntos_in_positivo], y[puntos_in_positivo], 'o', color="pink", label= "Puntos in +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_in_negativo], y[puntos_in_negativo], 'o', color="yellow", label= "Puntos in -", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_positivo], y[puntos_out_positivo], 'o', color="lime", label= "Puntos out +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_negativo], y[puntos_out_negativo], 'o', color="skyblue", label= "Puntos out -", alpha=0.5, markersize=2.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
...
plt.figure(figsize=(8,6))
plt.plot(x_values,f(x_values), label="Función", color="darkorange")
...
plt.plot(x[~puntos_in], y[~puntos_in], 'o', color="skyblue", label= "Puntos out", alpha=0.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
...
plt.fill_between(np.linspace(a,b, 1000), y1=0, y2=f(np.linspace(a,b, 1000)), color="brown", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
```
...
plt.figure(figsize=(8,6))
plt.plot(x_values,f(x_values), label="Función", color="yellow")
plt.fill_between(np.linspace(a,b, 100), y1=0, y2=f(np.linspace(a,b, 100)), color="deeppink", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
```
...
plt.plot(x[puntos_in_positivo], y[puntos_in_positivo], 'o', color="pink", label= "Puntos in +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_in_negativo], y[puntos_in_negativo], 'o', color="lime", label= "Puntos in -", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_positivo], y[puntos_out_positivo], 'o', color="yellow", label= "Puntos out +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_negativo], y[puntos_out_negativo], 'o', color="orange", label= "Puntos out -", alpha=0.5, markersize=2.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
...
plt.plot(x[puntos_in_positivo], y[puntos_in_positivo], 'o', color="deeppink", label= "Puntos in +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_in_negativo], y[puntos_in_negativo], 'o', color="red", label= "Puntos in -", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_positivo], y[puntos_out_positivo], 'o', color="brown", label= "Puntos out +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_negativo], y[puntos_out_negativo], 'o', color="pink", label= "Puntos out -", alpha=0.5, markersize=2.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
...
plt.fill_between(np.linspace(a,b, 100), y1=0, y2=f(np.linspace(a,b, 100)), color="darkgreen", alpha=0.5)
plt.grid()
plt.legend()
plt.axis('square')
plt.show()
...
plt.figure(figsize=(8,6))
plt.plot(x_values,f(x_values), label="Función", color="black")
plt.fill_between(np.linspace(a,b, 1000), y1=0, y2=f(np.linspace(a,b, 1000)), color="grey", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
```
...
plt.figure(figsize=(8,6))
plt.plot(x[puntos_in], y[puntos_in], 'o', color="yellow", label= "Puntos in", alpha=0.5)
plt.plot(x[~puntos_in], y[~puntos_in], 'o', color="orange", label= "Puntos out", alpha=0.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
...
plt.figure(figsize=(8,6))
plt.plot(x_values,f(x_values), label="Función", color="black")
plt.fill_between(np.linspace(a,b, 100), y1=0, y2=f(np.linspace(a,b, 100)), color="darkblue", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
```
...
plt.figure(figsize=(8,6))
plt.plot(x[puntos_in], y[puntos_in], 'o', color="brown", label= "Puntos in", alpha=0.5)
plt.plot(x[~puntos_in], y[~puntos_in], 'o', color="deeppink", label= "Puntos out", alpha=0.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
...
plt.plot(x_val, y_val1)
plt.plot(x_val, y_val2)
plt.fill_between(x_val, y1=y_val1, y2=y_val2, color="yellow", alpha=0.5)
plt.title("Región de Integración")
plt.grid()
plt.show()
```
...
plt.plot(x_val, y_val1)
plt.plot(x_val, y_val2)
plt.fill_between(x_val, y1=y_val1, y2=y_val2, color="lime", alpha=0.5)
plt.grid()
plt.show()
```
...
for x in x_val: 
  ...
  plt.fill_between(y, 0, y, color="deeppink", alpha=0.5)
...
plt.figure(figsize=(8,6))
plt.plot(x_values, beta.pdf(x_values, a, b), label="Función de Densidad Beta", color="deeppink")
plt.grid()
plt.legend()
...
plt.fill_between(x_fill, 0, beta.pdf(x_fill, a, b), color="orange", alpha=0.5)

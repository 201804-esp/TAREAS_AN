...
plt.plot(x, f(x), label= "e^x cos(x)", color="purple", linestyle="--")

plt.plot(x, p_2(x), label="Grado 2", color="deeppink")
plt.plot(x, p_3(x), label="Grado 3", color="green")
plt.plot(x, p_4(x), label="Grado 4", color="red")
plt.plot(x, p_5(x), label="Grado 5", color="orange")
...
plt.plot(xnew,  L2(xnew), label="L2", color="green")
plt.plot(xnew,  L3(xnew), label="L3", color="orange")
plt.plot(xnew,  L4(xnew), label="L4", color="deepPink")
...
plt.figure(figsize=(8,5))
plt.plot(xnew,  p(xnew), label="Polinomio", color="pink")
plt.plot(val_x,val_y, "o", ms=6, label="Datos", color="darkblue")
plt.grid()
plt.legend()
plt.show()
```
...
x_val = np.linspace(-0.5, 1, 500)
x_aprox = 0.43

plt.figure(figsize=(8,5))
plt.plot(x_val,  poliLagrange(x_val), label="Lagrange", color="purple")
plt.plot(x_val,  SNatural(x_val), label="Spline Natural", color="deeppink")
...
plt.axvline(x_aprox, color="grey", linestyle='--', label=f"x = {x_aprox}")
plt.title("f(x)= e^(2x)")
plt.xlabel ("x")
plt.ylabel ("y")
plt.grid()
...
plt.figure(figsize=(8,5))
plt.plot(x_val,  poliLagrange(x_val), label="Lagrange", color="cyan")
plt.plot(x_val,  SNatural(x_val), label="Spline Natural", color="orange")
plt.plot(x_val,  SCondicionado(x_val), label="Spline Condicionado", color="deeppink")
plt.plot(x, y,'o', label="Nodos de Interpolación", markersize=7, color="darkblue")

plt.axvline(x_aprox, color = "black", linewidth = 0.8, linestyle="--") 
plt.axhline(x_aprox, color = "black", linewidth = 0.8, linestyle="--")
plt.axvline(x_aprox, color="pink", linestyle='--', label=f"x = {x_aprox}")
...
plt.figure(figsize=(8,5))
plt.plot(x_values, poli_lagrange(x_values), label="Lagrange", color="red")
plt.plot(x_values, poli_spnat(x_values), label="Spline Natural", color="green")
plt.plot(x_values, poli_spcond(x_values), label="Spline Cond", color="pink")
plt.plot(x, y,'o', label="Nodos", color="orange")
...
plt.figure(figsize=(8,5))
plt.plot(x_new, polinomio(x_new), color="deeppink", label = "Lagrange")
...
plt.figure(figsize=(8,5))
plt.plot(xnew,  my_spline(xnew), label="Spline cúbico", color="green")
...
plt.figure(figsize=(8,5))
plt.plot(x_new, polinomio(x_new), color="green", label = "Lagrange")
plt.plot(xnew,  my_spline(xnew), label="Spline cúbico", color="orange")
plt.plot(x, y, "o", label="Nodos", color="darkred") 
...
plt.figure(figsize=(8,5))
plt.plot(xnew,  my_spline(xnew), label="Spline cúbico", color="purple")
plt.plot(val_x,val_y, "o", ms=6, label="Nodos", color="darkred")
...
plt.figure(figsize=(8,5))
plt.plot(x_new, polinomio(x_new), color="blue", label = "Lagrange")
plt.plot(xnew,  my_spline(xnew), label="Spline cúbico", color="deeppink")
plt.plot(x, y, "o", label="Nodos", color="darkred") 
...
plt.figure(figsize=(8,5))
plt.plot(x_new, y_new, "-", label="Spline Cúbico", color="darkblue")
